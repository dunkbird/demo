	...
	<div class="ui-content" role="main">
		<form id="add-user-frm">
			<div class="ui-field-contain">
				<label for="name2">姓名： <span style="color:red">*</span></label>
				<input type="text" name="userName" id="userName" value="" data-clear-btn="true">
			</div>
			<div class="ui-field-contain">
				<label for="name2">手机： <span style="color:red">*</span></label>
				<input type="text" name="telphone" id="telphone" value="" data-clear-btn="true">
			</div>
			<div class="ui-field-contain">
				<label for="name2">地址： </label>
				<input type="text" name="address" id="address" value="" data-clear-btn="true">
			</div>
			<div class="ui-field-contain">
				<label for="name2">公司： </label>
				<input type="text" name="company" id="company" value="" data-clear-btn="true">
			</div>			
			<div class="ui-field-contain">
				<label for="name2">职务： </label>
				<input type="text" name="job" id="job" value="" data-clear-btn="true">
			</div>	
			<div class="ui-field-contain">
